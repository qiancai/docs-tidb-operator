...
pingcap/tidb-backup     v1.2.0-beta.1                          A Helm chart for TiDB Backup or Restore
pingcap/tidb-cluster    v1.2.0-beta.1                          A Helm chart for TiDB Cluster
pingcap/tidb-drainer    v1.2.0-beta.1                          A Helm chart for TiDB Binlog drainer.
pingcap/tidb-lightning  v1.2.0-beta.1                          A Helm chart for TiDB Lightning
pingcap/tidb-operator   v1.2.0-beta.1          v1.2.0-beta.1          tidb-operator Helm chart for Kubernetes
pingcap/tikv-importer   v1.2.0-beta.1                          A Helm chart for TiKV Importer
```
...
wget http://charts.pingcap.org/tidb-drainer-v1.2.0-beta.1.tgz
wget http://charts.pingcap.org/tidb-lightning-v1.2.0-beta.1.tgz
```
