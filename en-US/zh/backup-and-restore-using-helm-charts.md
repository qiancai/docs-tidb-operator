...
aliases:
  - '/docs-cn/tidb-in-kubernetes/dev/backup-and-restore-using-helm-charts/'
  - '/docs-cn/dev/tidb-in-kubernetes/maintain/backup-and-restore/'
  - '/docs-cn/v3.0/tidb-in-kubernetes/maintain/backup-and-restore/'
  - '/docs-cn/v3.1/tidb-in-kubernetes/maintain/backup-and-restore/'
---
