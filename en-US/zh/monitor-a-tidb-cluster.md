...
aliases:
  - '/docs-cn/tidb-in-kubernetes/dev/monitor-a-tidb-cluster/'
  - '/docs-cn/tidb-in-kubernetes/dev/monitor-using-tidbmonitor/'
  - '/zh/tidb-in-kubernetes/dev/monitor-using-tidbmonitor/'
---
