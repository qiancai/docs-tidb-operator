...
category: how-to
aliases:
  - '/docs-cn/tidb-in-kubernetes/dev/configure-a-tidb-cluster/'
  - '/zh/tidb-in-kubernetes/dev/configure-cluster-using-tidbcluster/'
  - '/docs-cn/tidb-in-kubernetes/dev/configure-cluster-using-tidbcluster/'
---
