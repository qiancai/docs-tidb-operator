...
aliases:
  - '/docs-cn/tidb-in-kubernetes/dev/benchmark-sysbench/'
---
...
![OLTP Update Index](/media/oltp-update-index-qps.png) ![OLTP Update Index](/media/oltp-update-index-latency.png)
...
![OLTP Update No Index](/media/oltp-update-no-index-qps.png) ![OLTP Update No Index](/media/oltp-update-no-index-latency.png)
...
![OLTP Read Write](/media/oltp-read-write-qps.png) ![OLTP Read Write](/media/oltp-read-write-latency.png)
