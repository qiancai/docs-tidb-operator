...
TiDB Dashboard is a visualized tool introduced since TiDB v4.0 and is used to monitor and diagnose TiDB clusters. For details, se [TiDB Dashboard](https://docs.pingcap.com/tidb/stable/dashboard-intro).
